...
public interface StoreCustomRepository {
    ...
    Page<StoreResponseWithKeyword> findStoresByCondition(Pageable pageable, String categoryName, String keyword, String location, String storeName,  Boolean useSearchBtn);
